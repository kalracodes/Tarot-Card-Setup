 ...
 */
function zodiac_astrology_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function zodiacastrology_sanitize_css( $css ) {
 ...
 */
function zodiacastrology_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function zodiacastrology_sanitize_email( $email, $setting ) {
 ...
 */
function zodiacastrology_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function zodiacastrology_sanitize_html( $html ) {
 ...
 */
function zodiacastrology_sanitize_image( $image, $setting ) {
 ...
 */
function zodiacastrology_sanitize_nohtml( $nohtml ) {
 ...
 */
function zodiacastrology_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function zodiacastrology_sanitize_number_range( $number, $setting ) {
 ...
 */
function zodiacastrology_sanitize_select( $input, $setting ) {
 ...
 */
function zodiacastrology_sanitize_url( $url ) {
	return esc_url_raw( $url );
}

/*radio button sanitization*/
function zodiac_astrology_sanitize_choices( $input, $setting ) {
    global $wp_customize;
...
if ( ! function_exists( 'zodiac_astrology_sanitize_integer' ) ) {
	function zodiac_astrology_sanitize_integer( $input ) {
		return (int) $input;
	}
}
